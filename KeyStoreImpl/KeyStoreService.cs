...
namespace KeyStoreImpl
{
    ...
    public class RTKeyStoreService : IKeyStoreService
    {
        ...
        {
            string storageFile = Config.GetValue(KeyStoreImpl.Config.KEY_STORE_PATH);
        ...
        {
            string assymKeyContainer = Config.GetValue(KeyStoreImpl.Config.ASYM_KEY_PATH);
            ...
            {
                int keySize = int.Parse(Config.GetValue(KeyStoreImpl.Config.ASYM_KEY_SIZE_BITS));
